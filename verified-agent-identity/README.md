npm run setup-telegram  # Configura bot de Telegram# Opción 1: Gemini (recomendado)
# Ve a: https://makersuite.google.com/app/apikey
# Actualiza .env: GOOGLE_API_KEY=tu_clave_real

# Opción 2: Ollama local (100% gratis)
curl -fsSL https://ollama.ai/install.sh | sh
ollama pull llama3
# Actualiza .env: OLLAMA_MODEL=llama3OLLAMA_MODEL=llama3OLLAMA_MODEL=llama3# Verified Agent Identity
